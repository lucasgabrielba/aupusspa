...
export  function PowerPlantsMap() {
  return (
    <Card className="w-full bg-card text-card-foreground h-full rounded-sm">
      <CardHeader>
        <CardTitle>Mapa de localização das usinas</CardTitle>
        <CardDescription>
          Visualizar a localização geográfica das usinas para facilitar o monitoramento de consumo
        </CardDescription>
      </CardHeader>
      <CardContent>
